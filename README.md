...
|---|---|---|---|
| `sheets` (default) | `docs.google.com` | Manual cleanup script | [docs/setup_wizard.md](docs/setup_wizard.md) |
| `firebase` | `firebaseio.com` | Auto-delete after result | [docs/firebase.md](docs/firebase.md) |
